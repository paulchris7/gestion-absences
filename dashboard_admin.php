...
try {
    ...
    // Récupérer les dernières absences enregistrées
    $stmt = $pdo->query("
        SELECT a.*, e.nom as etudiant_nom, e.prenom as etudiant_prenom, m.nom as module_nom, s.date_seance, s.type_seance
        FROM absences a
        ...
        LIMIT 5
    ");
    $dernieres_absences = $stmt->fetchAll();
                    ...
                    <tbody>
                        <?php foreach ($derniers_etudiants as $etudiant): ?>
                            <tr>
                                ...
                                <td><?php echo $etudiant['filiere_nom']; ?></td>
                    ...
                    <tbody>
                        <?php foreach ($dernieres_absences as $absence): ?>
                            <tr>
                                ...
                                <td><?php echo $absence['module_nom']; ?></td>
