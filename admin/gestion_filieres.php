    ...
    <div class="card-body">
        <form action="gestion_filieres.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="code" name="code" value="<?php echo $filiere['code']; ?>" required>
                <small>Ex: GI, RSSP, GIL...</small>
            </div>
            
            <div class="form-group">
                <label for="nom">Nom de la filière</label>
                <input type="text" class="form-control" id="nom" name="nom" value="<?php echo $filiere['nom']; ?>" required>
                <small>Ex: Génie Informatique, Réseaux et Systèmes de Sécurité et de Production...</small>
            </div>
            
            <div class="form-group">
                <label for="description">Description</label>
                <textarea class="form-control" id="description" name="description" rows="3"><?php echo $filiere['description']; ?></textarea>
            </div>
                    ...
                    <?php foreach ($filieres as $f): ?>
                        <tr>
                            ...
                            <td class="table-actions">
                                <a href="gestion_filieres.php?edit=<?php echo $f['id']; ?>" class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="#" class="btn btn-sm btn-danger delete-btn" data-id="<?php echo $f['id']; ?>" data-name="<?php echo $f['code'] . ' - ' . $f['nom']; ?>">
